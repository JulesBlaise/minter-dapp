...
const welcome_p = 'The True Italian Pizza Army, aka TIPA, traveling around different worlds and galaxies looking for other flavors of Pizza Soldiers. Will they find peace, or are they just walking into battle?';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Pre-Sale Minting Open!!";
...
const p_public_mint = "You're on the whitelist for the pre-sale! 🎉";
